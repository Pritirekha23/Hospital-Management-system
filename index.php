  ...
  <header class="header">
    <a href="#" class="logo"> <i class="fas fa-heartbeat"></i> <strong>Sum</strong> Hospital </a>
     ...
     <nav class="navbar">
        ...
        <a href="patient.php"><button style=" box-shadow: var(--box-shadow);color: black;border-radius: 10px;padding:15px;
        font-weight:300">REGISTER</button></a>
        <a href="login.php"><button style=" box-shadow: var(--box-shadow);color: black;border-radius: 10px;padding:15px;
        font-weight:300">LOG IN</button></a>
